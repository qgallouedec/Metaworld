...
class SawyerBasketballEnvV2(SawyerXYZEnv):
    ...
    def __init__(self):
        ...
        self.goal = np.array([0, 0.9, 0], dtype=np.float32)
        ...
        self.goal_space = Box(
            np.array(goal_low, dtype=np.float32) + np.array([0, -0.083, 0.2499], dtype=np.float32),
            np.array(goal_high, dtype=np.float32) + np.array([0, -0.083, 0.2501], dtype=np.float32)
        )
